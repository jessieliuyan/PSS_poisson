...
$$V(b_1|H_1)=\frac{1}{1-p}+\frac{1}{pe^{b_1}}$$  
...
$$N=\frac{\bigg(Z_{1-\alpha/2}\sqrt{V(b_1|H_1)}+Z_{1-\beta}\sqrt{V(b_1|H_0^*)} \bigg)^2}{tb_1^2}(3)$$

For Bernoulli distribution,  
$$b^*=log(\int f(x)e^{b_0+b_1x}dx)=log(pe^{b_0}e^{b_1}+(1-p)e^{b_0})$$  

The variance under null hypothesis,  
$$V(b_1|H_0^* )= \frac{1}{p(1-p)e^{b^* }}$$  
  
The variance under althernative hypothesis,  
$$V(b_1|H_1)=\frac{1}{(1-p)e^{b_0}}+\frac{1}{pe^{b_1}e^{b_0}}$$  
...
<img src="samplesize.png" width="1341" />
...
<img src="effectsize.png" width="1461" />
